"""
Django settings for MetaboPredict2023 project.
...
ALLOWED_HOSTS = os.environ.get('ALLOWED_HOSTS', 'metabopredict.onrender.com').split(',')
...
ROOT_URLCONF = 'MetaboPredict2023.urls'
...
WSGI_APPLICATION = 'MetaboPredict2023.wsgi.application'
